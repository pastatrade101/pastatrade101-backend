...
const DEFAULT_SECTIONS: Record<ReportType, string[]> = {
  ...
  daily: ['market_status', 'what_changed', 'btc_risk', 'macro_regime', 'altcoin_btc', 'ecosystem', 'exit_strategy', 'derivatives', 'alt_btc_bottom', 'early_opportunity', 'risk_warnings', 'premium_takeaway', 'disclaimer'],
  // Weekly — trend development.
  weekly: ['market_status', 'what_changed', 'btc_risk', 'macro_regime', 'log_regression', 'onchain', 'social', 'altcoin_btc', 'ecosystem', 'strongest_signals', 'weakest_areas', 'exit_strategy', 'derivatives', 'alt_btc_bottom', 'early_opportunity', 'confirmation_needed', 'risk_warnings', 'premium_takeaway', 'data_coverage', 'disclaimer'],
  // Monthly — full market structure.
  monthly: ['market_status', 'executive_summary', 'what_changed', 'market_posture', 'btc_risk', 'macro_regime', 'btc_cycle', 'log_regression', 'onchain', 'social', 'altcoin_btc', 'ecosystem', 'strongest_signals', 'weakest_areas', 'exit_strategy', 'exit_simulation_example', 'derivatives', 'alt_btc_bottom', 'early_opportunity', 'confirmation_needed', 'risk_warnings', 'premium_takeaway', 'data_coverage', 'disclaimer'],
