...
const DEFAULT_SECTIONS: Record<ReportType, string[]> = {
  ...
  premium: ['market_status', 'executive_summary', 'what_changed', 'market_posture', 'btc_risk', 'btc_cycle', 'onchain', 'social', 'altcoin_btc', 'ecosystem', 'strongest_signals', 'weakest_areas', 'confirmation_needed', 'risk_warnings', 'premium_takeaway', 'data_coverage', 'disclaimer'],
