...
const DEFAULT_SECTIONS: Record<ReportType, string[]> = {
  ...
  daily: ['market_status', 'what_changed', 'btc_risk', 'altcoin_btc', 'ecosystem', 'exit_strategy', 'derivatives', 'risk_warnings', 'premium_takeaway', 'disclaimer'],
  // Weekly — trend development.
  weekly: ['market_status', 'what_changed', 'btc_risk', 'log_regression', 'onchain', 'social', 'altcoin_btc', 'ecosystem', 'strongest_signals', 'weakest_areas', 'exit_strategy', 'derivatives', 'confirmation_needed', 'risk_warnings', 'premium_takeaway', 'data_coverage', 'disclaimer'],
  // Monthly — full market structure.
  monthly: ['market_status', 'executive_summary', 'what_changed', 'market_posture', 'btc_risk', 'btc_cycle', 'log_regression', 'onchain', 'social', 'altcoin_btc', 'ecosystem', 'strongest_signals', 'weakest_areas', 'exit_strategy', 'exit_simulation_example', 'derivatives', 'confirmation_needed', 'risk_warnings', 'premium_takeaway', 'data_coverage', 'disclaimer'],
  special: ['market_status', 'executive_summary', 'what_changed', 'btc_risk', 'risk_warnings', 'premium_takeaway', 'disclaimer'],
  premium: ['market_status', 'executive_summary', 'what_changed', 'market_posture', 'btc_risk', 'btc_cycle', 'log_regression', 'onchain', 'social', 'altcoin_btc', 'ecosystem', 'strongest_signals', 'weakest_areas', 'exit_strategy', 'exit_simulation_example', 'derivatives', 'confirmation_needed', 'risk_warnings', 'premium_takeaway', 'data_coverage', 'disclaimer'],
